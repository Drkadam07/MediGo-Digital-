...
// 		</div>
// 		{/* Know More Button */}
// 		<div className="p-2 md:p-4 pt-0 text-center">
// 			<button className="bg-gradient-to-r text-gray-800 font-semibold rounded-full from-white via-[#add8e6] to-[#f8d7da] hover:bg-gradient-to-r hover:from-[#add8e6] hover:to-white py-2 px-6 transition-all">
// 				Know More
// 			</button>
// 		</div>
// 	</div>
...
// 						<h2 className="uppercase text-xl font-extrabold md:text-2xl lg:text-3xl leading-tight font-medium mb-6">
			...
			<div className="container px-4 mx-auto">
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto mt-12">
					...
					<div className="hidden sm:block">
						<img
							src="https://source.unsplash.com/500x400/?healthcare,digital"
